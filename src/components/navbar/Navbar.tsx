...
export default function Navbar() {
  ...
  return (
    <nav className='absolute w-full bg-white shadow-md'>
      <div className='mx-auto flex h-20 max-w-screen-2xl items-center justify-between px-4 md:px-8 lg:px-16'>
        ...
        <div className='flex items-center justify-center gap-3 md:gap-11'>
          {Login ? (
            ...
            <div className='flex items-center justify-center gap-3'>
              <Link
                href={'/auth/login'}
                className='rounded-[15px] py-2 px-4 md:py-[10px] md:px-[20px] font-semibold text-primary transition-all hover:bg-primary hover:text-white hover:shadow-primary/40 hover:drop-shadow-lg'
              >
                Login
              </Link>
              <Link
