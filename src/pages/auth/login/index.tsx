            ...
            <div className="flex h-screen items-center justify-center">
                ...
                >
                    ...
                    <h3 className="pb-20 text-xl">
                        New user?{" "}
                        <Link href="/auth/register" className="underline-animation text-primary hover:text-primary text-color-mint">
                            Create an account
                        </Link>
                    </h3>

                    <div className="flex w-full flex-col items-start justify-center pb-10">
                        <label className="pb-3 text-lg font-medium text-[#9F9F9F]">Your email address</label>
                        <input
                            type="email"
                            placeholder=""
                            name="email"
                    ...
                    <div className="flex w-full flex-col justify-center pb-24">
                        <label className="pb-3 text-lg font-medium text-[#9F9F9F]">Your password</label>
                        ...
                        <div className="text-end">
                            <Link href="/auth/forgot-password" className="float-right w-fit text-primary">
