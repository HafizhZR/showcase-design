            ...
            <div className="flex h-screen items-center justify-center">
                <div className="flex h-full w-full basis-1/2 flex-col items-center justify-center text-white sm:-mr150">
                    ...
                    <div className="absolute brightness-50 sm:hidden">
                        <Image src={bgLogin} alt="Background Login" className="h-screen" loading="lazy" />
                    </div>
                    <Link href="/" className="absolute top-5 left-5 rounded-full bg-white p-2 text-black hover:opacity-50">
                ...
                >
                    ...
                    <h3 className="pb-8 text-xl">
                        ...
                        <Link href="/auth/login" className="underline-animation text-primary hover:text-primary">
                            Log In Here
                        </Link>
                    </h3>

                    <div className="flex w-full flex-col items-start justify-center pb-10">
                        <span className="pb-3 text-lg font-medium text-[#9F9F9F]">Full Name</span>
                        <input
                            type="text"
                            placeholder=""
                            name="fullName"
                    ...
                    <div className="flex w-full flex-col items-start justify-center pb-10">
                        <span className="pb-3 text-lg font-medium text-[#9F9F9F]">Email Address</span>
                        <input
                            type="email"
                            placeholder=""
                            name="email"
                    ...
                    <div className="flex w-full flex-col items-start justify-center pb-10">
                        <span className="pb-3 text-lg font-medium text-[#9F9F9F]">Password</span>
                        <input
                            type="password"
                            placeholder=""
                            name="password"
                    ...
                    <div className="flex w-full flex-col justify-center pb-24">
                        <span className="pb-3 text-lg font-medium text-[#9F9F9F]">Confirm Password</span>
