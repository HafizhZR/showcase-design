...
export default function Home() {
  return (
    <>
      ...
      <div className='min-h-screen flex flex-col md:flex-row md:items-center py-8 px-8 -mt-14'>
        <div className='md:order-2 max-w-md flex justify-center mb-5 mt-10'>
          <Image
            src={headLogo}
            alt='Logo'
            width={800}
        ...
        <div className='md:order-1'>
          <h1 className='text-2xl font-bold ml-10 sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-5xl mb-5'>
      ...
      <div className='flex justify-center'>
        <div className='w-full p-5'>
          ...
          <section className='mt-4'>
            <p className='text-lg text-center font-semibold m-auto px-20'>
